import { Crown, ScrollText, Sparkles } from 'lucide-react'; // Necesitarás instalar lucide-react
...
<main className="flex flex-col justify-center h-screen flex items-center max-w-xl mx-auto px-6 py-12">
        {/* Encabezado con efecto de subrayado creativo */}
        ...
        {/* Cuerpo del texto con mejor legibilidad y tarjetas sutiles */}
